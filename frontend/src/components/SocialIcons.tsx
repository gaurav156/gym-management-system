// Standard, well-tested glyphs (Bootstrap Icons, MIT licensed) rather than hand-drawn
// approximations - a custom-drawn "f" is easy to get subtly wrong at small sizes, and a
// wrong-looking brand mark is worse than a slightly different style from the rest of the
// icon set. Both are solid (fill=currentColor) so they pick up whatever text color the
// surrounding link/button is using, same as before.
